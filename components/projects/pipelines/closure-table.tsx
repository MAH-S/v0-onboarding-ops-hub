...
export function ClosureTable({ projects, onOpenControls }: ClosureTableProps) {
      ...
      filtered.sort((a, b) => {
        ...
        switch (sortColumn) {
          ...
          case "dueDate":
            ...
            break
          case "closureStep":
            comparison = (a.closureStep || 0) - (b.closureStep || 0)
            break
          case "progress":
          ...
          {sortedProjects.length === 0 ? (
            ...
            sortedProjects.map((project) => (
              ...
              >
                ...
                <TableCell>
                  <span className="text-sm">{getClosureStepLabel(project.closureStep)}</span>
                </TableCell>
